...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Pelaporan Kematian Penduduk</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <form class="p-3 mt-3" id="register_form" name=register_form method="post" style="display:none;">
            ...
            <input style="margin-top:10px" class="form-control" type="text" name="NIK" id="NIK" placeholder="NIK" maxlength = "16" autocomplete="off">
