    ...
    <header id="header" class="fixed-top"> 
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="lihat_laporan_kabupaten.php">Laporan<span class="sr-only">(current)</span></a>
                </li>
                <div class="dropdown">
                        <li class="nav-item">
...
<script type="text/javascript">
    $(document).ready(function() {
        datafl = JSON.parse(localStorage.getItem('DataLapkabupaten'))[<?= $_GET["key"]?>]
        console.log(datafl)
        ...
        $('#cancel').on('click', function() {
            location.replace('lihat_laporan_kabupaten.php');
        });
    });
</script>
</body>
