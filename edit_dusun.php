...
<script>
    $(document).ready(function() {
        datafl = JSON.parse(localStorage.getItem('DataDusun'))[<?= $_GET["key"]?>]
        console.log(datafl)

        $("#kecamatan").val(datafl['nama_kecamatan']);
        $("#desa").val(datafl['nama_desa']);
        $("#inputdusun").val(datafl['nama_dusun']);
        ...
        $('#update').on('click', function() {
            ...
            form_data.append("action","update_dusun");
