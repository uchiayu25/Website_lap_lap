...
<body>
    <header id="header" class="fixed-top"> 
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="kecamatan_page.php">Beranda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="lihat_laporan_kecamatan.php">Laporan</a>
                </li>
                <li class="nav-item">
        ...
        <!-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="kecamatan_page.php">Beranda <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="lihat_laporan_kecamatan.php">Laporan</a>
                </li>
    ...
    <section id="hero" class="d-flex align-items-center">
        <img src="image\dashboard.png" class="img-fluid" alt="">
    </section>
    <!-- Location -->
        ...
        <form class="container-fluid tabel mt-lg-5">
            <div class="container in">
                ...
                <div class="row justify-content-end mr-2">
                    ...
                    <button type="button" class="col-md-1" type="button" class="col-md-1" data-bs-toggle="modal" data-bs-target="#exampleModal">Export</button>
                </div>
                <table class="table mt-3 activemb-5">
                    <thead class="thead-dark">
                        <tr>
                            <th scope="col">No</th>
                            <th scope="col" id="datatampil">Nama Desa</th>
    ...
    <div style="width:29.7cm; border: black 0.5px solid; display:none" id="exportData" >
        <div style="text-align:center">
            ...
            <hr>
            <br> -->
            <h4 style="margin:0"><b>LAPORAN AGREGAT KEMATIAN PENDUDUK</b></h4>
        ...
        <table class="center" style="margin-top:20px; border: 1px solid black; border-collapse: collapse;">
            <thead>
                ...
                <th style="border: 1px solid black; border-collapse: collapse; width: 500px" id="tampil">NAMA KELURAHAN/DESA</th>
...
<script>
    ...
    if(datafl['role'] == "1"){
        ...
        $("#wilayahsur").html(datafl['nama_kecamatan'].toUpperCase());
    ...
    function datachange(){
        ...
        $.ajax({
            type: 'GET',
            url: "datasignup.php?aksi=get_agrekecamatan&kecamatan="+kecamatan+"&desa="+desa+
                "&dusun="+dusun+"&awal="+awal+"&akhir="+akhir,
            success: function(data) {
                ...
                localStorage.setItem("Dataagrekecamatan", JSON.stringify(dataFull));
            }
        });
    }
    ...
    $.ajax({
        type: 'GET',
        url: "datasignup.php?aksi=get_agrekecamatan2&id_kecamatan="+datafl['kode_kecamatan'],
        success: function(data) {
            dataFull = JSON.parse(data)
            count = 1
            laki = 0;
            ...
            Object.keys(dataFull).forEach(function(key){
                $("#lapotabel").append("<tr>"+
                                ...
                                $("#isiTabel").append("<tr>"+
                                    "<td scope='col' style='border: 1px solid black; border-collapse: collapse; text-align:center'>"+count+"</td>"+
                                    "<td scope='col' style='border: 1px solid black; border-collapse: collapse'>"+dataFull[key]['nama_desa']+"</td>"+
                                    "<td scope='col' style='border: 1px solid black; border-collapse: collapse; text-align:center'>"+dataFull[key]['laki_laki']+"</td>"+
                                    "<td scope='col' style='border: 1px solid black; border-collapse: collapse; text-align:center'>"+dataFull[key]['perempuan']+"</td>"+
                                    "<td scope='col' style='border: 1px solid black; border-collapse: collapse; text-align:center'>"+dataFull[key]['total']+"</td>"+
                                    "</tr>"
