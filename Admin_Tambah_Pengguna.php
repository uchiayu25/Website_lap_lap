...
<header id="header" class="fixed-top"> 
    ...
    <div class="wrapper mt-15">
        ...
        <form class = "p-1 mt-2" id="tambah1_form" name="tambah1_form" method="post" style="display:none;">
            ...
            <input style="margin-top:10px" class="form-control" type="text" name="NIK" id="NIK1" placeholder="NIK" autocomplete="off" maxlength = "16">
        ...
        <form class = "p-1 mt-2" id="tambah2_form" name="tambah2_form" method="post" style="display:none;">
            ...
            <input style="margin-top:10px" class="form-control" type="text" name="NIK" id="NIK2" placeholder="NIK" autocomplete="off" maxlength = "16">
