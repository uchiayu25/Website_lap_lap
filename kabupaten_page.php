...
<body>
    <header id="header" class="fixed-top"> 
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="kabupaten_page.php">Beranda</a>
                </li>
                <li class="nav-item">
        ...
        <!-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex me-auto">
    ...
    <div style="width:29.7cm; border: black 0.5px solid; display:none" id="exportData" >
        ...
        <div style="position:absolute;left:30px">
                ...
                <p style="margin-top:60px" id="nama_kadis">Drs. Anak Agung Ngurah Arimbawa</p>
                <p style="line-height:0" id="nip_kadis">NIP 196511161987031006 </p>
            </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Nama Kepala Dinas</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <input type="text" class="form-control" id="nameKadis" placeholder="Nama Kepala Dinas">
                <input type="text" class="form-control" id="NIPKadis" style="margin-top:10px" placeholder="NIP Kepala Dinas">
            </div>
...
<script>
    ...
    function exportingData() {
        $("#nama_kadis").html($("#nameKadis").val())
        if($("#NIPKadis").val()==""){
            $("#nip_kadis").html("NIP. "+"-")
        }else{
            $("#nip_kadis").html("NIP. "+$("#NIPKadis").val())
        }
