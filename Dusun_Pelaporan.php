            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="dropdown">
                        <li class="nav-item active">
                            <a class="nav-link">Formulir<span class="sr-only">(current)</span></a>
                            <div class="dropdown-content">
        ...
        <form class = "container" enctype = "multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" id="inputKK" placeholder="Nomor Kartu Keluarga" maxlength = "16">
                </div>
                <div class="form-group col-6">
                    <label for="inputNIK">NIK</label>
                    <input type="text" class="form-control" id="inputNIK" placeholder="NIK" maxlength = "16">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" id="inputNIKPelapor" placeholder="NIK Pelapor" maxlength = "16">
                </div>
                <div class="form-group col-6">
            ...
            <div class="mt-lg-5 text-right">
                <button type="button" class="btn btn-primary rounded-pill" name="tambah" value="tambah" id="tambah" >Tambah</button>
                <button type="button" class="btn btn-secondary rounded-pill">Kembali</button>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#tambah").on('click', function(){
            ...
            $("#ktp_input").removeClass("is-invalid")
            // $("#kk_input").removeClass("is-invalid")
            // $("#skk_input").removeClass("is-invalid")
            $("#waktu").removeClass("is-invalid")

            tanggal_lapor      = today2
            ...
            form_data.append("action","tambah_laporan");
            ...
            form_data.append("nama_lengkap_kepdusun",datafl['nama_lengkap']);
            $.ajax({
                url: 'datasignup.php',
                dataType: 'text',
                cache: false,
                ...
                success: function(response){
                    // alert("hai")
                    if(response == 1 ){
                        alert("Berkas Tidak lengkap");
                    } else{
                        alert("Laporan berhasil ditambahkan");
                        location.replace('laporan_baru_dusun.php');
                    }
                }
            });
        });
