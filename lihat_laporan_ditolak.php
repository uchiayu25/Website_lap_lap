...
<body>
    ...
    <section class="laporan container">
        ...
        <div class="logo col-5">
                    <img src="image\laporanditolak.png" alt="">
        </div>
...
<script>
    ...
    function hapus(key,kode){
        $.ajax({
        type: 'GET',
        url: "datasignup.php?aksi=del_lapodesa&id_dusun="+kode+"&id_laporan="+key,
        success: function(data) {
            ...
            localStorage.setItem("DataLapdusuntolak", JSON.stringify(dataFull));
        }
        });
    }

    function edit(key){
        location.replace("edit_laporan_tolak.php?key="+key)
    }

    $.ajax({
        type: 'GET',
        url: "datasignup.php?aksi=get_lapotolak&id_dusun="+datafl['kode_dusun'],
        success: function(data) {
            dataFull = JSON.parse(data)
            count = 1
            $("#laptabel").empty()
    ...
    function datachange(){
        ...
        $.ajax({
            type: 'GET',
            url: "datasignup.php?aksi=get_lapotolak2&kecamatan="+kecamatan+"&desa="+desa+
